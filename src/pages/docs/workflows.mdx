...
- **Blueprint Catalog** — Operators can start from pre-built templates for code review, documentation, research, sprint planning, meal planning, and more. Blueprint lineage tracks the template origin and any customizations applied.
