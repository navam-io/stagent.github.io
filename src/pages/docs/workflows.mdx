...
- **Workflow Library** — The main list shows each workflow’s pattern, status, step count, and duplication controls. Five patterns are currently supported.
...
<BrowserFrame src="/screenshots/dashboard-workflow-confirm.png" alt="Create Workflow from AI Assist showing 4 generated steps with profile assignments" />
