...
- **AI Assist** — The creation form generates sub-task suggestions from a brief, letting operators bootstrap detailed task descriptions with AI support.
...
<BrowserFrame src="/screenshots/dashboard-create-form-ai-applied.png" alt="Task creation form after AI suggestions applied to the description field" />
