...
- **Claude Agent SDK** — Embedded Claude runtime with streaming, tool use, and governance callbacks
- **Codex App Server** — OpenAI runtime with resumable thread semantics, approvals, and provider-aware event streaming
