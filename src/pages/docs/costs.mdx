...
Every provider-calling activity writes to a normalized usage ledger instead of relying on runtime-specific log parsing. That includes task runs, resumes, workflow child tasks, schedule firings, task assist, and profile tests.
