...
- **Profile Gallery** — Browse 13+ curated specialist profiles across work and personal domains from one searchable, filterable catalog.
- **Cross-Provider Compatibility** — Profiles work across both Claude and OpenAI runtimes, so switching providers does not require rebuilding agent definitions.
...
- **GitHub Import** — Import profiles from GitHub URLs to share configurations across teams or adopt community-built specialists.
