...
<BrowserFrame src="/screenshots/profiles-list.png" alt="Profiles catalog with Import/Create, search, and specialist cards including tags and ratings" />

## Key Concepts

- **Profile Gallery** — Browse 21 curated specialist profiles across work and personal domains from one searchable, filterable catalog.
- **Cross-Provider Compatibility** — Profiles work across both Claude and Codex runtimes, so switching providers does not require rebuilding agent definitions.
