...
<BrowserFrame src="/screenshots/settings-list.png" alt="Settings with Claude OAuth and API Key authentication, plus OpenAI Codex Runtime configuration" />
...
The settings page also manages runtime connections — OAuth and API Key authentication for Claude, plus OpenAI Codex Runtime configuration with connection testing for each provider.
